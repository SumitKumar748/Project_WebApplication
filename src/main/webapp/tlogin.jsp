...
<body style="margin:0px;max-width:1980px;height:1000px;">
        ...
        <div class="background" style="border:5px solid white;border-top:none;
		    ...
		    <form action="teacherlogin" method="post" class="container" style="margin:auto;border:none;height:auto;background-color:#E0E0E0;max-width:35%; display: flex;
                ...
                <input class="i1" name="tid" placeholder="Enter Email" type="email" required>
                <label class="l1" style="text-decoration:none;color:black;font-size:55px;">Password</label>
                <input class="i1" name="password" placeholder="Enter Password" type="password" required> <!-- Changed tpwd to password -->
                <center><label style="color:blue;text-align:center; font-size:25px;margin-top:5px;margin-bottom:5px;">${msg}</label></center>

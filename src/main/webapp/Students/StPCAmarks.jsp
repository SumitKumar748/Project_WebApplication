...
<body style="max-width:1980;max-height:1000px;margin:0px;">
...
<div id="maindiv" style="margin:0px;height:900px;border: 5px solid white;
      ...
      <div  style="height:auto;width: 75%;
		            		...
		            		<h1>PCA (Practical Continuous Assessment) Marks</h1>
                	
			                <table border="n" style="width:95%;border:1px solid black;text-align:center;border-radius:5px;">
			                
			                	<tr style="">
			                        <th style="font-size:22px;width:70%;padding:10px;">Subject</th>
			                        <th style="font-size:22px;">PCA-1</th>

        ...
        <div class="background" style="border:5px solid white;border-top:none;
            ...
            ">
              ...
              <br><br>
                    ...
                    <form action="studentlogin" method="post" class="container" style="margin:auto;border:none;height:auto;background-color:#E0E0E0;max-width:45%; display: flex;
                                ...
                                <input class="i1" name="sid" placeholder="Enter Registration Number" type="number" required>
                                ...
                                <span style="font-size:20px;">Contact to your respective College.</span>
                                <br>
                                <br>
                    </form>

...
<body style="margin:0px;border:2px solid white;max-width:1980px;height:1000px;">
...
<div id="maindiv" style=" max-width:1980px;justify-content:center;">
	 	...
	 	<div class="background" style="border:5px solid white;border-top:none;
		    ...
		    <form action="studentlogin" method="post" class="container" style="margin:auto;border:none;height:750px;background-color:#E0E0E0;width:35%; display: flex;
